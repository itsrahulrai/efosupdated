        ...
        <tr>
            <td align="center">
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    style="background:#ffffff; border-radius:10px; overflow:hidden; box-shadow:0 5px 15px rgba(112, 61, 61, 0.08);">
                    ...
                    <tr>
                        <td style="padding:35px;">
                            ...
                            <p style="color:#4b5563; font-size:15px;">
                                You can now access your student dashboard and start your learning journey.
                            </p>
                    ...
                    <tr>
                        <td style="background:#f9fafb; padding:20px; text-align:center; font-size:13px; color:#6b7280;">
                            <p style="margin:0;">© {{ date('Y') }} EFOS. All Rights Reserved.</p>
                        </td>
                    </tr>
