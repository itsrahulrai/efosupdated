                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="course-details-card p-4 mb-4">
                            <h4 class="fw-bold mb-4" style="color: #1a1a1a;">Your Selected Course</h4>

                            <div class="row g-4">
                                <div class="col-md-4">
                                    <img src="{{ static_asset($course->thumbnail ?? 'assets/images/course-default.jpg') }}"
                                        class="course-thumbnail w-100" alt="{{ $course->title }}">
                                </div>

                                <div class="col-md-8">
                                    <h5 class="course-title">{{ $course->title }}</h5>
                                    <p class="course-description">
                                        {{ Str::limit($course->short_description, 180) }}
                                    </p>
                        ...
                        <div class="order-summary-card p-4">
                            ...
                            @if ($course->has_discount)
                                <div class="price-row price-discount">
                                    ...
                                    <span>- ₹{{ number_format($course->price - $course->final_price) }}</span>
                                </div>
                            @endif
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <span class="price-total">₹ {{ number_format($course->final_price) }}</span>
                            </div>

                            <form method="POST" action="{{ route('payment.initiate', $course->id) }}">
                                @csrf
