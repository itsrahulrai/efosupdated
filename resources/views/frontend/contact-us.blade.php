...
@section('title', 'Contact us | EFOS Edumarketers Pvt Ltd')
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4">
                            <div class="item">
                                ...
                                <h3 class="mt-20 mb-1">Office Location</h3>
                                <p>
                                    A147, Main Gate, opposite Central School, Sector P3, Block A, Phi III, Greater Noida,
                        ...
                        <div class="col-lg-4">
                            <div class="item">
                                <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_1443_2078)">
                                        <path
                                    ...
                                    <defs>
                                        <clipPath id="clip0_1443_2078">
                                            <rect width="70" height="70" fill="white" />
                                        </clipPath>
                                    </defs>
                                </svg>
                                <h3 class="mt-20 mb-1">connect@efos.in</h3>
                                <p>Email us anytime for any kind <br>
                                    of query.</p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="item">
                                ...
                                <h3 class="mt-20 mb-1">Phone : +91 94038 90820</h3>
                                <p>Call us any kind suppor,we <br>
                                    will wait for it.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-5 order-2 order-lg-1">
                        <div class="contact__map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.9028077590015!2d77.51926379999999!3d28.4523461!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ceb0625e0c285%3A0x9366315d528513be!2sEFOS%20Edumarketers%20Pvt%20Ltd!5e0!3m2!1sen!2sin!4v1765263400937!5m2!1sen!2sin"
                    ...
                    <div class="col-lg-7 order-1 order-lg-2">
                        <div class="contact__item">
                            <div class="section-header mb-40">
                                <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Contact US
                                </h5>
                                <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Get In
                                    <span>Touch <img src="{{ static_asset('assets/images/shape/header-shape.png')}}" alt="shape"></span>
                                </h2>
                            </div>
                            <form action="{{ route('contact.store') }}" method="POST" id="contactForm" novalidate>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input id="phone" name="phone" type="text" class="form-control" placeholder="Your Phone" required>
                                ...
                                <button type="submit" class="btn btn-danger btn-lg mt-3">
                                    Send Now <i class="fa-light fa-arrow-right-long"></i>
                                </button>
                                </form>
                        </div>
                    </div>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const badWords = ["sex","porn","xxx","adult","nude"];
    const badLinks = /(http|https|www\.)/i;
    const scriptTag = /<\s*script/ig;

    // NAME
    name.addEventListener("input", () => {
        const regex = /^[A-Za-z\s]+$/;
        if (!regex.test(name.value)) {
            setInvalid(name, "nameError", "Only letters and spaces allowed");
        } else {
            setValid(name);
        }
    });
    ...
    phone.addEventListener("input", () => {
        ...
        if (phone.value.length !== 10) {
            setInvalid(phone, "phoneError", "Enter valid 10 digit number");
        } else {
            setValid(phone);
        }
    });
    ...
    email.addEventListener("input", () => {
        ...
        if (!regex.test(email.value)) {
            setInvalid(email, "emailError", "Enter valid email address");
        } else {
            setValid(email);
        }
    });
    ...
    message.addEventListener("input", () => {
        ...
        if (scriptTag.test(text)) {
            setInvalid(message, "messageError", "Script tags are not allowed");
        }
        else if (badLinks.test(text)) {
            setInvalid(message, "messageError", "Links are not allowed");
        }
        else if (badWords.some(w => text.includes(w))) {
            setInvalid(message, "messageError", "Inappropriate words not allowed");
        }
        else {
            setValid(message);
        }
